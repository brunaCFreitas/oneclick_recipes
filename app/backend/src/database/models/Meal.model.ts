...
MealModel.init(
  {
    ...
    strMeal: { type: DataTypes.STRING },
    strDrinkAlternate: { type: DataTypes.STRING },
    strCategory: { type: DataTypes.STRING },
    strArea: { type: DataTypes.STRING },
    strInstructions: { type: DataTypes.TEXT },
    strMealThumb: { type: DataTypes.STRING },
    strTags: { type: DataTypes.STRING },
    strYoutube: { type: DataTypes.STRING },
    ...
    strSource: { type: DataTypes.STRING },
    strImageSource: { type: DataTypes.STRING },
